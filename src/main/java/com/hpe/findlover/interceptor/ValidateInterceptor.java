...
//
//import com.hpe.findlover.util.Validator;
...
//	private Logger logger = LogManager.getLogger(ValidateInterceptor.class) ;
//	@Override
//	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
//		boolean flag = true ;	// 默认放行
//		try {
//			// 需要取得HandlerMethod对象，这样可以取得相关的Controller信息
//			HandlerMethod handlerMethod = (HandlerMethod) handler;
//			// 表示具体的验证处理操作，所有的错误信息通过Map返回
//			Map<String, String> errors = Validator.validate(request, handlerMethod);
//			if (errors.size() > 0) { // 有错
